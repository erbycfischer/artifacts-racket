...
;; before any request leaves the process, exactly like get-account-details.

;; Current subscription details (404 when none is active).
(define (get-my-subscription #:config [config (current-config)])
