...
- Account and character reads: account details, characters, bank, pending items, purchase history, gems history, active/history tasks, auctions, rate limits, and logs.
